...
#CHECK FOR OVERDISPERSION & ZERO INFLATION
#1 - Linear model for overdispersion and zero inflation testing
#2 - Negative binomial mixed model
#3 - Zero inflated negative binomial mixed model
